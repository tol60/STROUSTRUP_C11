// g++ -g -w -Wall -std=c++11 ch18.3.2.Copy_Assignment_SelfAssignmentBug.C -o ch18.3.2.Copy_Assignment_SelfAssignmentBug.exe 2>&1 | tee tmp.txt
// Note:
// Deleting the old data before creating new ones could cause self-assignment problems
// This code is supposed to demonstrate that
#include <iostream>
