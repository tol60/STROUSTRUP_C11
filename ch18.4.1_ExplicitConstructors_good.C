// g++ -g -w -Wall -std=c++11 ch18.4.1_ExplicitConstructors_good.C -o ch18.4.1_ExplicitConstructors_good.exe 2>&1 | tee tmp.txt
// BAD case:
...
{
  cout << "*************************************\n";
  cout << "Explicit was used in this version\n";
  cout << "*************************************\n";
