/*  Modified get_int to include the message for greeting and a message for error;
 *        int get_int(int low, int high, const string& greeting, const string& sorry) // read an int in [low:high] from cin
...
// g++ -std=c++11 -g ch10.7.2_get_int_message.C  -o ch10.7.2_get_int_message.exe 2>&1 | tee tmp.txt
