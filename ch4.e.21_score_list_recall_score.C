...
// If you enter the score, the program will retrieve all the names with this score or type "score not found"
// g++ -std=c++11 -g -o ch4.e.21_score_list_recall_score.exe ch4.e.21_score_list_recall_score.C  2>&1 | tee tmp.txt
...
int main ()
{
  ...
  // If you enter the score, the program will retrieve all the names with this score or type "score not found"
  cout <<endl;
  cout << "You can enter the score, and I will retrieve all the names with this score \"score not found\"\n";
