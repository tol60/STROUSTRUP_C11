...
// this version can only handle 12!
// g++ -std=c++11 -g -o ch6.e.10_permutations_combinations_v1_12!.exe ch6.e.10_permutations_combinations_v1_12!.C  2>&1 | tee tmp.txt
...
int factorial (int a) {
  ...
  int result = 1; // default value for a=0;
