// g++ -g -w -Wall -std=c++11 ch18.3.4_Moving_Bad.C -o ch18.3.4_Moving_Bad.exe 2>&1 | tee tmp.txt
// BAD:
...
*/
  ...
  cout << "********************\n";
  cout << "********************\n";
  cout << "calling vector v3 = f3(); Result will be copied?? to a new vector\n";
  vector v3 = f3();
  ...
  cout << "calling v4=f3(); Result will be copied to a new vector\n";
  v4 = f3();
  cout << "v4 is located at " << &v4 << endl;
  cout << "v4[0] is located at " << &v4[0] << endl;
  cout << "returned from function f3()\n";
