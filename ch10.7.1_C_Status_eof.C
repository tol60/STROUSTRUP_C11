...
// g++ -std=c++11 -g ch10.7.1_C_Status_eof.C  -o ch10.7.1_C_Status_eof.exe 2>&1 | tee tmp.txt
...
int main ()
{
  ...
  cout << "Experimenting with integer loop:\n";
  int n;
  while (true) {
    cin>>n;
    cin_state("After entering int n, ");
    cout << endl;
    if (cin.eof()) {
