...
/* ch14.d.4_ReferenceToBase_New_f
 ...
 *
   g++ -w -Wall -std=c++11 ch14.d.4_ReferenceToBase_New_f.C -o ch14.d.4_ReferenceToBase_New_f.exe
...
int main ()
{
  ...
  cout<< "\n  B1& bref = d1; Calling bref.vf() and bref.f():\n";
