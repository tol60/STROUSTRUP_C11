// g++ -std=c++11 -g -o ch7.e.7.calculator08buggy_fixed.exe ch7.e.7.calculator08buggy_fixed.C  2>&1 | tee tmp.txt
...
const string quit_str = "quit"; // string that will be used to quit the calculator
const string let_str = "let"; // string used to denote variables
const string const_str = "const"; // string used to denote constants
const string help_str = "HELP"; // string that will be used for user to request help (upper or lower case)
